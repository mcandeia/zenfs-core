...
Deno.test('write and read file with specified content', async () => {
...
Deno.test('write and read file using buffer', async () => {
...
Deno.test('write base64 data to a file and read it back asynchronously', async () => {
	const data =
...
Deno.test('write file synchronously with custom mode', () => {
...
Deno.test('append to a file synchronously with custom mode', () => {
