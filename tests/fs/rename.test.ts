...
Deno.test('rename directory', async () => {
...
Deno.test('File to Directory and Directory to File Rename', async () => {
...
Deno.test('rename directory inside itself', async () => {
