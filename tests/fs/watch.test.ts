...
Deno.test('fs.watch should emit events on file change', async () => {
...
Deno.test('fs.watch should emit events on file rename (delete)', async () => {
	using watcher = fs.watch(testFile, (eventType, filename) => {
...
Deno.test('fs.watchFile should detect changes to a file', async () => {
...
Deno.test('fs.unwatchFile should stop watching the file', async () => {
...
Deno.test('fs.watch should work with directories', async () => {
...
Deno.test('fs.watch should detect file renames', async () => {
...
Deno.test('fs.watch should detect file deletions', async () => {
